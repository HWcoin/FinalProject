 ...
 */
public class MyNewsComAdapter extends RecyclerView.Adapter<MyNewsComAdapter.CommentViewHolder>{
    ...
    public MyNewsComAdapter(Context context, ArrayList<CommentInfoResp> items, Long userId) {
